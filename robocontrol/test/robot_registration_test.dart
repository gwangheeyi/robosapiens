...
void main() {
  ...
  testWidgets('로봇 운영 맨 위에 차례가 보인다', (tester) async {
    ...
    expect(find.text('Nav2 설정 내보내기'), findsOneWidget);
    expect(find.text('Nav2 백엔드'), findsOneWidget);
    expect(find.text('백엔드 시작'), findsOneWidget);
    expect(find.textContaining('RMF와 Gazebo는 실행하지 않습니다'), findsOneWidget);
