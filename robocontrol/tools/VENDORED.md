...
여기서는 `parents[1]` 이 `robocontrol/` 라 그 둘이 없습니다. **코드 잘못이
...
## 다시 가져오기
    ...
    cp /tmp/trihouse/trihouse_omx/*.py        robocontrol/tools/
    cp /tmp/trihouse/trihouse_omx/.gitignore  robocontrol/tools/
