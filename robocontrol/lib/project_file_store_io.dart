...
Directory _packageRoot() {
  ...
  if (repositoryRoot != null && repositoryRoot.isNotEmpty) {
    final package = Directory('$repositoryRoot/robocontrol').absolute;
