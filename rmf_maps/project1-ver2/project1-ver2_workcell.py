...
WORKCELLS = [
    ('omx_01', 'omx_01', 'omx_f', ['픽업3'], [], ['trihouse-porkbelly@1.0.0']),
]
...
# 있느냐뿐이다.
POLICY_RUNNER = '/home/gyi/robosapiens/rmf_maps/project1-ver2/project1-ver2_policy_runner.py'
...
POLICY_LOG = os.path.join(
    ...
    'project1-ver2_policy_runner.log')
...
DOCK_HEADINGS = {
    '드랍오프2': 3.115413,  # 178.500도
    '픽업3': 1.576032,  # 90.300도
}
